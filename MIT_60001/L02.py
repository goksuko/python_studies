...
name = "ana"
greet = hi + name  
print(greet) # hi thereana
greeting = hi + " " + name
print(greeting) # hi there ana
silly = hi + (" " + name)*3
print(silly) # hi there ana ana ana
...
x = 1
print(x)
x_str = str(x) # casting integer to a string
print("my fav number is", x, ".", "x=", x) # when sees , python puts space in between
...
mysum = 0
for i in range(7, 10): # range(start, stop) step = 1
   mysum += i
print(mysum)

mysum = 0
for i in range(5, 11, 2): # range (start, stop, step)
   mysum += i
   if mysum == 5:
       break
       mysum += 1
